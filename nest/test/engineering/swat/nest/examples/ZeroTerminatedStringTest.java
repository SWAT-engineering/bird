...
public class ZeroTerminatedStringTest {
    ...
    void utf16() {
        ...
        assertEquals(input, UTF16ZeroTerminated.parse(wrap(zeroTerminated), Context.DEFAULT).value);
    }
    ...
    void ascii() {
        ...
        assertEquals(input, ASCIIZeroTerminated.parse(wrap(zeroTerminated), Context.DEFAULT).value);
    }
